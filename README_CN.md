...
- 多语言界面：支持跟随系统，以及英文、简体中文、繁体中文、日文、韩文、德文、法文、俄文、葡萄牙文、西班牙文和意大利文。
...
褚岩: 立刻返回，登上“魔戒”的计划取消了。</pre>
      ...
      <td width="36%" valign="top">
        <a href="https://cosmicrealm.github.io/VoiceStudio/dialogue-demo.html">
          <img alt="打开播放页" src="https://img.shields.io/badge/%E2%96%B6-%E6%89%93%E5%BC%80%E6%92%AD%E6%94%BE%E9%A1%B5-0969da?style=for-the-badge">
        </a>
      </td>
    </tr>
  </tbody>
...
2. 进入 `模型` 页面，点击 `安装/修复运行环境`，安装 MLX、mlx-audio、transformers、Hugging Face CLI 和 ffmpeg。
3. 在 `模型` 页面下载需要的语音模型。
